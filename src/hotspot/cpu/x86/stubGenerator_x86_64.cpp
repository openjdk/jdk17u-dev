...
// int com.sun.security.provider.DigestBase.implCompressMultiBlock(byte[] b, int ofs, int limit)
  ...
  address generate_sha3_implCompress(bool multiBlock, const char *name) {
    ...
    __ lea(permsAndRots, ExternalAddress(StubRoutines::x86::permsAndRots_addr()));
    __ lea(round_consts, ExternalAddress(StubRoutines::x86::round_consts_arr_addr()));
...
#define __ masm->
  ...
  void generate_all() {
    ...
    if (UseSHA3Intrinsics) {
      StubRoutines::x86::_round_consts_arr_addr = (address)StubRoutines::x86::_round_consts_arr;
      StubRoutines::x86::_permsAndRots_addr = (address)StubRoutines::x86::_permsAndRots;
